                    ...
                    <table class="table table-sm table-bordered" id="table">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" width="30%">Diskon</th>
                                <th class="text-center" width="15%">Harga Setelah Diskon</th>
                        ...
                        <tbody>
                            @foreach ($dpp as $data)
                                <tr>
                                    ...
                                    <td class="text-center">{{ number_format($data->diskon) }} %</td>
                                    <td>
                                        <i class="fab fa-bootstrap fa-lg text-primary me-3"></i>
                                        @php $diskon = $data->harga - (($data->diskon / 100) * $data->harga); @endphp
                                        <strong>Rp. {{ number_format($diskon) }}</strong>
                                    </td>
                                    <td class="text-end">
